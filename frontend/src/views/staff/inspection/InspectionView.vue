    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="inspectionData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>检查类型：</b>
            <span v-if="inspectionData.checkType == 1">康复记录</span>
            <span v-if="inspectionData.checkType == 2">饮食检查</span>
            <span v-if="inspectionData.checkType == 3">后疑症状</span>
        </a-col>
      </a-row>
      <br/>
      <br/>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">回访图片</span></a-col>
